<template>
  <el-container>
    ...
    <el-footer height="340" class="student-footer">
      <div class="container">
        <div class="footer-main">
          <h4>知识库</h4>
          <a href="https://www.chinaedu.com/zsd/xiaoxue/" target="_blank" class="footer-main-link">小学知识库</a>
          <a href="https://www.chinaedu.com/zsd/chuzhong/" target="_blank" class="footer-main-link">初中知识库</a>
          <a href="https://www.chinaedu.com/zsd/gaozhongzhong/" target="_blank" class="footer-main-link">高中知识库</a>
          <a href="https://gaokao.chinaedu.com/" target="_blank" class="footer-main-link">高考</a>
        </div>
        <div class="footer-main">
          <h4>关于我们</h4>
    ...
    <div class="foot-copyright">
      <span>Copyright © 2020 吴晓洁  毕业设计</span>
    </div>
  </el-container>
</template>
